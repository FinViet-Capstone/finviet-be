...
public partial class FinVietDbContext : DbContext
{
    ...
    {
        // The application configures DbContext via DI in Infrastructure/DependencyInjection.
        // Keep this fallback only for direct/manual context construction.
        if (!optionsBuilder.IsConfigured)
        {
            optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=Project_Capstone_Finviet;Username=postgres;Password=12345");
        }
    }
